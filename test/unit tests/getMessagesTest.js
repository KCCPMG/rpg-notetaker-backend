...
let {newUser, newThread, befriendRequest, CHAT, getMessages} = controls;
...
runTest = async() => {
  ...
  // let messages = await getMessages(testUser._id);
  // console.log(messages);
  
  deepPrint(await getMessages(testUser._id, true));
