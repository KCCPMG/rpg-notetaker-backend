...
let {newUser, newCampaign, newThread, campaignInvite, campaignInviteAccept, CHAT, promoteToDm, stepDownDm} = controls;
...
runTest = async() => {
  ...
  // let stepDown = await stepDownDm({
  //   sender: testUser._id,
  //   campaignId: campaign._id,
  //   threadIds: [campaign.threadId],
  //   text: "It has been an honor and a privilege to serve as your test GM"
  // });
  ...
  // console.log({stepDown}, {campaign}, {campaignThread}, {testUser2});

  deepPrint(await stepDownDm({
    sender: testUser._id,
    campaignId: campaign._id,
    threadIds: [campaign.threadId],
    text: "It has been an honor and a privilege to serve as your test GM"
