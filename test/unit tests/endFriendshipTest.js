...
let {newUser, newThread, befriendRequest, CHAT, befriendAccept, endFriendship} = controls;
...
runTest = async() => {
  ...
  // console.log(await endFriendship({
  //   sender: testUser2._id,
  //   origMessage: bfReq._id,
  //   threadIds: [bfReq.threadIds[0]],
  //   text: "I just realized u suck", 
  // }));
