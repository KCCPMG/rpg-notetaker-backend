...
let {newUser, newCampaign, newThread, newIndexEntry, campaignInvite, campaignInviteAccept, CHAT, editIndexEntry} = controls;
...
runTest = async() => {
 ...
 let ie = await newIndexEntry({
  ...
  deepPrint(await editIndexEntry({
    id: ie._id,
    lastEditedBy: testUser2._id,
    campaignId: campaign._id,
    term: "El Duderino",
    alternateTerms: ["The Dude", "His Dudeness", "Duder"],
    tags: ["Protagonist", "Detective", "Stoner", "Bum"],
    text: "Deadbeat",
  }, true))
