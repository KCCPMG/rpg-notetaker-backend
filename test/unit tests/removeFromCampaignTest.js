...
let {newUser, newCampaign, newThread, campaignInvite, campaignInviteAccept, CHAT, removeFromCampaign} = controls;
...
runTest = async() => {
  ...
  // let remove = await removeFromCampaign({
  //   sender: testUser._id,
  //   directRecipient: testUser2._id,
  //   campaignId: campaign._id,
  //   threadIds: [testThread, campaignThread._id],
  //   text: "Go back to the shadow",
  // });
  ...
  // console.log({remove}, {campaign}, {campaignThread}, {testUser2});
  
  deepPrint(await removeFromCampaign({
    sender: testUser._id,
    directRecipient: testUser2._id,
    campaignId: campaign._id,
    threadIds: [testThread, campaignThread._id],
